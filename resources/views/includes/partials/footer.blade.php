         ...
         <div class="row">
             <div class="col-lg-3 col-md-6">
                 <div class="footer-item">
                     <img src="{{ asset('img/logo/main-logo.png') }}" alt="{{ config('app.name') }}" width="150">
                     <p class="lh-lg mb-4">
                     ...
                     <div class="footer-icon d-flex">
                         <a class="btn btn-primary btn-sm-square me-2 rounded-circle" href="">
             ...
             <div class="col-lg-3 col-md-6">
                 <div class="footer-item">
                     ...
                     <div class="d-flex flex-column align-items-start">
                         <p><i class="fa fa-map-marker-alt text-primary me-2"></i> 1st Floor, Uganda Hse, Kenyatta
         ...
         <div class="row">
             <div class="col-md-12 text-center text-md-start mb-3 mb-md-0">
                 <span class="text-light">
                     <a href="#">
                         <i class="fas fa-copyright text-light me-2"></i> <span
                             style="color: #fff;">{{ config('app.name') }}</span>
